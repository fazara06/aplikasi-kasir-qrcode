    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            <form action="{{ route('menu.update', $menu) }}" method="POST" enctype="multipart/form-data">
                ...
                <!-- Tenant -->
                <div class="mb-4">
                    <label for="menu_category_id" class="block text-sm font-medium text-gray-700 mb-1">Tenant</label>
                    <select 
                ...
                <!-- Tipe Menu -->
                <div class="mb-4">
                    <label for="tipemenu" class="block text-sm font-medium text-gray-700 mb-1">Tipe Menu</label>
                    <select 
                        name="tipemenu" 
                        id="tipemenu" 
                        required
                    ...
                    >
                        ...
                        <option value="makanan" {{ old('tipemenu', $menu->tipemenu) == 'makanan' ? 'selected' : '' }}>Makanan</option>
                        <option value="minuman" {{ old('tipemenu', $menu->tipemenu) == 'minuman' ? 'selected' : '' }}>Minuman</option>
                    </select>
                    @error('tipemenu')
